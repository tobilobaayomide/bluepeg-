  ...
  const resources = [
    {
      ...
      description: "Explore the latest trends shaping industrial automation and how Bluepeg is leading the way.",
      link: "/resource-center/automation-trends-2025",
      image: "/globe.svg",
    },
    {
      title: "Bluepeg Case Study: Power Solutions",
      description: "A deep dive into our successful power and drive solutions for a major client.",
      link: "/resource-center/case-study-power",
      image: "/file.svg",
    },
    {
      title: "Whitepaper: Sustainable Growth in Nigeria",
      description: "Our whitepaper on driving sustainable growth through innovative industrial operations.",
      link: "/resource-center/whitepaper-growth",
      image: "/window.svg",
    },
    {
      title: "Guide: Choosing the Right Automation Partner",
      description: "Key considerations and a checklist for selecting an automation partner in West Africa.",
      link: "/resource-center/automation-partner-guide",
      image: "/vercel.svg",
    },
    {
      title: "Resource: Instrumentation & Control FAQ",
      description: "Answers to the most common questions about instrumentation and control systems.",
      link: "/resource-center/instrumentation-faq",
      image: "/next.svg",
    },
    {
      title: "E-book: The Future of Manpower Development",
      description: "Insights into upskilling and workforce development for the industrial sector.",
      link: "/resource-center/manpower-ebook",
      image: "/workers.jpg",
    },
    ...
    <section className="w-full bg-gradient-to-br from-[#f8fafc] via-white to-[#e3f0ff] py-14 border-b border-gray-100 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-2 md:px-8">
        ...
        <p className="text-base text-gray-500 text-left mb-6 italic px-4 md:px-8">
          Explore our latest resources, guides, and insights to help you stay ahead in industrial operations and automation.
        </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 px-4 md:px-8">
          {resources.map((resource, i) => (
            <div key={i} className="bg-white rounded-lg shadow-md hover:shadow-lg transition border border-gray-100 flex flex-col">
              <div className="h-40 w-full flex items-center justify-center bg-gray-50 rounded-t-lg">
                <img src={resource.image} alt={resource.title} className="h-20 w-auto object-contain" loading="lazy" />
              </div>
              <div className="p-5 flex-1 flex flex-col">
                <h3 className="font-bold text-lg text-[#0a225a] mb-2">{resource.title}</h3>
                <p className="text-gray-600 text-sm mb-4 flex-1">{resource.description}</p>
                <a href={resource.link} className="mt-auto inline-block text-[#007BFF] font-semibold hover:underline text-sm">Read More</a>
              </div>
            </div>
          ))}
        </div>
